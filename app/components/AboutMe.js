    ...
    <section className="w-full min-h-screen flex items-center bg-black px-8 md:px-24">
      <div className="max-w-7xl w-full flex flex-col md:flex-row items-center md:items-start justify-between gap-12">
        ...
        <div className="flex-1 min-w-[320px]">
          {/* Section label */}
          <div className="mb-8">
            <span className="tracking-[0.3em] text-[#c6bba7] text-sm font-darker-grotesque uppercase">about me</span>
          </div>
          {/* Main headline */}
          <h1 className="font-darker-grotesque text-[#c6bba7] text-[5vw] md:text-[3vw] leading-[1.08] font-normal text-left">
