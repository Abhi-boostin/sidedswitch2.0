...
export default function HeroSection() {
  return (
    <div id="hero" className="w-full h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="w-[60vw] h-[70vh] bg-transparent flex flex-col items-center justify-center gap-4 relative z-10">
        <SplitText
          text="SIDESWITCH"
          className="font-outfit tracking-[0.1em] text-[#e79600] text-[8vw] md:text-[7vw] lg:text-[6vw] uppercase text-center drop-shadow-[0_4px_24px_rgba(231,150,0,0.25)]"
          delay={60}
          duration={0.6}
          ease="power3.out"
          splitType="chars"
        ...
        />
        {/* Motto goes here */}
        <span className="mt-4 text-[#c6bba7] text-xl font-darker-grotesque text-center" style={{ fontWeight: 'normal' }}>
          {/* Add your motto here */}
